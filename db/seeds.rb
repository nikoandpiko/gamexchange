...
request1.body = 'fields artworks,cover.*,category,genres.name,name,rating, platforms; where platforms = 48  & rating > 70; limit 1;'
...
request3.body = 'fields artworks,cover.*,category,genres.name,name,rating, platforms; where platforms = 49; limit 10;'
