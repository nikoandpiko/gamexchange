...
request1.body = 'fields artworks,cover,category,genres.name,name,rating, platforms; where platforms = 48 & rating > 90; limit 100;'
...
request2.body = 'fields artworks,cover,category,genres.name,name,rating, platforms; where platforms = 130 & rating > 90; limit 100;'
